// talentdeck/app.js — Talent Builder (v4)
// - Contact fields (owner)
// - Load from lines or pipe format
// - Inline edit per talent
// - Autosave (localStorage) + keep last 20 inputs
// - Generate: opens /view-talent/?compact=1&data=... and copies Bitly short link
// - Export PDF: postMessage {type:'print'} to preview
// - Toggle "Enable clicks in preview"
...
(function () {
  ...
  function openPreview() {
    ...
    // compact=1 som default for strammere print
  ...
  function loadFromTextarea() {
    ...
    for (let i = 0; i < lines.length; i++) {
      ...
      // Single link/ID (optionally next line image)
  ...
  // live save/preview for project + contact
  ...
  function applyPreviewClicks(){
    els.preview.style.pointerEvents = els.toggleClicks && els.toggleClicks.checked ? 'auto' : 'none';
  }
  if (els.toggleClicks) els.toggleClicks.addEventListener('change', applyPreviewClicks);
